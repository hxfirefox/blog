...
直截了当地设计过多地暴露细节造成扩展性和维护性也直截了当地下降，这种结局是所有开发人员都努力想避免的，如此看来简单设计并不简单，或者套用一句经典的广告语:简约而不简单。让我们试着重新解读简单设计，简单设计可以分成两个层次:

- 实现具有用户价值的需求，简单的说就是用户要什么你就给他什么
- 代码设计应当职责简单，简单地说就是做好一件事
让我们看看从上面角度怎么来设计，仍然以上面的例子为例。

根据这个原则，将上述需求实例化，可以得到：
